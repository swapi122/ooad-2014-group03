...
public class listenmask {
	...
	private void initialize() {
		...
		lblNewLabel.setBounds(1, 1, 526, 25);
		...
		panel_1.setBounds(11, 32, 156, 258);
		panel.add(panel_1);
		...
		lblNewLabel_2.setBounds(10, 22, 325, 74);
		panel_2.add(lblNewLabel_2);
		
		JButton btnclose = new JButton("Close");
		btnclose.setForeground(new Color(0, 0, 255));
		btnclose.setFont(new Font("Tahoma", Font.PLAIN, 20));
		btnclose.setBounds(412, 245, 106, 45);
		panel.add(btnclose);
	}
}
